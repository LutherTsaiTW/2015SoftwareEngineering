<?php session_start();
        ...
        $selectReq = "SELECT * FROM req as r WHERE r.rid NOT IN (SELECT rid FROM test_relation WHERE tid =" . $tid . ")  AND r.rproject=$pid AND (r.rstatus=1 OR r.rstatus=2 OR r.rstatus=3 OR r.rstatus=4)";
